...
CREATE TABLE `chat_group` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1913273913378414594 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='聊天群表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_group` VALUES (1913268584758419457,2,2,'http://www.baidu.com','测试1群','{\"chatGroupId\":1913268584758419457,\"createTime\":1744995080197,\"id\":1913274155280703489,\"noticeContent\":\"测试1群，包含了1、2、3号用户\",\"updateTime\":1744995080197,\"userId\":2}',3,_binary '\0','2025-04-19 00:29:12','2025-04-19 00:51:20'),(1913273913378414593,2,2,'http://www.baidu.com','测试2群','{\"chatGroupId\":1913273913378414593,\"createTime\":1744995091774,\"id\":1913274203850743810,\"noticeContent\":\"测试2群，包含了4、2、3号用户\",\"updateTime\":1744995091774,\"userId\":2}',3,_binary '\0','2025-04-19 00:50:22','2025-04-19 00:51:31');
...
CREATE TABLE `chat_group_member` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1913273914984833028 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='聊天群成员表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_group_member` VALUES (1913268585463062529,1913268584758419457,1,NULL,'admin','2025-04-19 00:29:12','2025-04-19 00:29:12'),(1913268585463062530,1913268584758419457,2,NULL,'patriclee','2025-04-19 00:29:12','2025-04-19 00:29:12'),(1913268585525977090,1913268584758419457,3,NULL,'yannqing','2025-04-19 00:29:12','2025-04-19 00:29:12'),(1913273914984833025,1913273913378414593,2,NULL,'patriclee','2025-04-19 00:50:22','2025-04-19 00:50:22'),(1913273914984833026,1913273913378414593,3,NULL,'yannqing','2025-04-19 00:50:22','2025-04-19 00:50:22'),(1913273914984833027,1913273913378414593,4,NULL,'test','2025-04-19 00:50:22','2025-04-19 00:50:22');
...
CREATE TABLE `chat_group_notice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1913274203850743811 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='聊天群公告表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_group_notice` VALUES (1913274155280703489,1913268584758419457,2,'测试1群，包含了1、2、3号用户','2025-04-18 16:51:20.197','2025-04-18 16:51:20.197'),(1913274203850743810,1913273913378414593,2,'测试2群，包含了4、2、3号用户','2025-04-18 16:51:31.774','2025-04-18 16:51:31.774');
...
CREATE TABLE `chat_list` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1913275440772005890 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='聊天列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_list` VALUES (1913270659823230977,2,1913268584758419457,_binary '\0',0,'{\"formUserId\":\"2\",\"formUserName\":\"patriclee\",\"formUserPortrait\":\"http://www.nbcpe.cn:9000/cni-bbs-open/userFile/2/avatar/f6facd72eec24121.png\",\"type\":\"text\",\"content\":\"patriclee 向群1913268584758419457 发送消息1\",\"ext\":\"\"}','group',NULL,'2025-04-19 00:37:26','2025-04-19 00:37:26'),(1913275027234603009,2,3,_binary '\0',0,'{\"formUserId\":\"2\",\"formUserName\":\"patriclee\",\"formUserPortrait\":\"http://www.nbcpe.cn:9000/cni-bbs-open/userFile/2/avatar/f6facd72eec24121.png\",\"type\":\"text\",\"content\":\"patriclee 向yannqing 发送消息1\",\"ext\":\"\"}','user',NULL,'2025-04-19 00:54:48','2025-04-19 00:54:48'),(1913275440772005889,3,2,_binary '\0',0,'{\"formUserId\":\"3\",\"formUserName\":\"yannqing\",\"formUserPortrait\":\"http://www.nbcpe.cn:9000/cni-bbs-open/userFile/3/avatar/bef4e00190c346ef.jpg\",\"type\":\"text\",\"content\":\"向yannqing 向 patriclee 发送消息\",\"ext\":\"\"}','user',NULL,'2025-04-19 00:56:26','2025-04-19 00:56:26');
...
CREATE TABLE `chat_message` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1913275440709091330 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='消息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_message` VALUES (1913270659441549313,2,1913268584758419457,'text','message',_binary '','{\"formUserId\":\"2\",\"formUserName\":\"patriclee\",\"formUserPortrait\":\"http://www.nbcpe.cn:9000/cni-bbs-open/userFile/2/avatar/f6facd72eec24121.png\",\"type\":\"text\",\"content\":\"patriclee 向群1913268584758419457 发送消息1\",\"ext\":\"\"}',0,'group','2025-04-19 00:37:27','2025-04-19 00:37:27'),(1913274781301547009,2,3,'text','message',_binary '','{\"formUserId\":\"2\",\"formUserName\":\"patriclee\",\"formUserPortrait\":\"http://www.nbcpe.cn:9000/cni-bbs-open/userFile/2/avatar/f6facd72eec24121.png\",\"type\":\"text\",\"content\":\"patriclee 向yannqing 发送消息1\",\"ext\":\"\"}',0,'user','2025-04-19 00:53:49','2025-04-19 00:53:49'),(1913275440709091329,3,2,'text','message',_binary '\0','{\"formUserId\":\"3\",\"formUserName\":\"yannqing\",\"formUserPortrait\":\"http://www.nbcpe.cn:9000/cni-bbs-open/userFile/3/avatar/bef4e00190c346ef.jpg\",\"type\":\"text\",\"content\":\"向yannqing 向 patriclee 发送消息\",\"ext\":\"\"}',0,'user','2025-04-19 00:56:27','2025-04-19 00:56:27');
...
) ENGINE=InnoDB AUTO_INCREMENT=1911795038267236354 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='关注表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `follow` VALUES (1849345965757042690,1,3,NULL,1,1,'confirmed','2024-10-24 15:03:32','2024-10-26 13:13:43'),(1850059335011418113,3,2,NULL,2,1,'confirmed','2024-10-26 14:18:12','2025-04-19 00:53:00'),(1850406125187485697,2,1,NULL,2,1,'rejected','2024-10-27 13:16:13','2025-02-14 17:36:42'),(1850406173078048769,2,3,NULL,2,1,'confirmed','2024-10-27 13:16:25','2024-10-27 13:16:25'),(1890591066991452161,1,4,NULL,1,1,'confirmed','2025-02-15 10:36:50','2025-04-19 00:48:30'),(1891133879177039873,3,4,NULL,1,1,'confirmed','2025-02-16 22:33:47','2025-02-16 22:33:47'),(1891133951335845889,2,4,NULL,1,1,'confirmed','2025-02-16 22:34:04','2025-02-16 22:34:04'),(1891340991480045570,1,1,NULL,1,1,'pending','2025-02-17 12:16:46','2025-02-17 12:16:46'),(1891341653450268673,3,1,NULL,1,1,'confirmed','2025-02-17 12:19:24','2025-02-17 12:19:24'),(1891363277436194817,1,2,NULL,1,1,'pending','2025-02-17 13:45:19','2025-04-19 00:48:53');
...
CREATE TABLE `social_user` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1911796700507660290 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='第三方用户信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `social_user` VALUES (1911794785984045057,'10078777','patriclee','PatricLee','-1','https://foruda.gitee.com/avatar/1722950860515646667/10078777_patrifclee_1722950860.png',NULL,NULL,NULL,NULL,'hello,your got me:)','GITEE',0,'2025-04-14 22:52:51','2025-04-14 22:52:51'),(1911796700507660289,'106750474558215271643','cyhlbh2010@gmail.com','BingHua Lee','-1','https://lh3.googleusercontent.com/a/ACg8ocJ_XRQ_CrJWYGLHtv_xSBiMgozp4qS6jVovZ3n2Od_WE4ULyR0PMQ=s96-c',NULL,NULL,NULL,'cyhlbh2010@gmail.com',NULL,'GOOGLE',0,'2025-04-14 23:00:27','2025-04-14 23:00:27');
...
CREATE TABLE `social_user_rel` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1911796849061134337 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='第三方用户信息关联系统用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `social_user_rel` VALUES (1911795424847462400,2,'1911794785984045057'),(1911796849061134336,1911796849032159233,'1911796700507660289');
...
CREATE TABLE `user` (
  ...
  `public_username` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '对外公开的用户名（唯一标识）',
  `nick_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '' COMMENT '用户昵称（显示名称）',
...
) ENGINE=InnoDB AUTO_INCREMENT=1911796849032159234 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_role_rel` (
  ...
  `is_deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '逻辑删除(0：未删除 1：已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1911796849052745729 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户角色关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_role_rel` VALUES (1,1,1,'2024-10-13 02:49:23','2024-10-13 02:49:29',_binary '\0'),(2,2,3,'2024-10-13 02:49:23','2024-10-13 02:49:29',_binary '\0'),(3,3,3,'2024-10-13 02:49:23','2024-10-13 02:49:29',_binary '\0'),(4,4,5,'2024-10-13 15:13:49','2024-10-13 15:13:49',_binary '\0'),(1911796849052745728,1911796849032159233,6,'2025-04-14 23:01:02','2025-04-14 23:01:02',_binary '\0');
...
-- Dump completed on 2025-04-19  0:57:13
