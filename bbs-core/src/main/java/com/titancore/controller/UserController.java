...
public class UserController {
    ...
    public Response<UserLoginVo> getUserInfoByToken(){
    ...
    public Response<String> checkUserStoresLive(){
        StpUtil.checkLogin();
    ...
    public Response<List<UserVo>> recommendedUser(@PathVariable(name="userId",required = false) String userId){
    ...
    public Response<UserRegisterVo> register(@RequestBody RegisterUserDTO registerUserDTO){
    ...
    public Response<Boolean> checkUserIfExist(@PathVariable String account){
    ...
    public Response<UserVerificationCodeVo> checkUserVerificationCode(@RequestBody VerificationCodeForUserDTO verificationCodeForUserDTO){
    ...
    public Response<UserResetPasswordVo> resetPassword(@RequestBody ResetPasswordUserDTO resetPasswordUserDTO){
    ...
    public Response<DMLVo> socialUserBindLocalUser(@RequestBody BindSocialUserDTO bindSocialUserDTO){
